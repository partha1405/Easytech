...
namespace Easytech
{
    public partial class Form10 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else if (this.textBox3.Text != "" && this.textBox3.Text.Length != 15) MessageBox.Show("Please enter valid GST NO.");
            else
            {
        ...
        private void textBox3_Leave(object sender, EventArgs e)
        {
            ...
            else if (this.textBox3.Text.Length == 15)
            {
                ...
                this.textBox4.Text = this.textBox3.Text.Substring(2, 10);
            }
