...
namespace Easytech
{
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else if (this.textBox5.Text.Length != 10) MessageBox.Show("Enter 10 digit mobile number.");
            else if (this.textBox7.Text != "" && this.textBox7.Text.Length != 15) MessageBox.Show("Please enter valid GST NO.");
            else
            {
        ...
        private void textBox7_Leave(object sender, EventArgs e)
        {
            ...
            else if (this.textBox7.Text.Length == 15)
            {
                ...
                this.textBox8.Text = this.textBox7.Text.Substring(2, 10);
            }
            else MessageBox.Show("Please enter valid GST NO.");
        }
